...
{
    public partial class frm_Excluir_Funcionario : Form
    {
        public frm_Excluir_Funcionario(string codigo)
        {
            InitializeComponent();
        ...
        {
            DialogResult resultado = MessageBox.Show("Deseja excluir o cadastro do funcionário " + txt_Nome.Text + " ?", "Programa Oficina",
                MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (resultado == DialogResult.Yes)
            {
                cls_Funcionario.Unit func = new cls_Funcionario.Unit();
                func.DeleteFuncionario(txt_Codigo.Text);
