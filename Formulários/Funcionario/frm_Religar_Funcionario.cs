...
{
    public partial class frm_Religar_Funcionario : Form
    {
        public frm_Religar_Funcionario(string codigo)
        {
            InitializeComponent();
        ...
        {
            DialogResult resultado = MessageBox.Show("Deseja religar o cadastro do funcionário " + txt_Nome.Text + " ?", "Programa Oficina",
                MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (resultado == DialogResult.Yes)
            {
                cls_Funcionario.Unit func = new cls_Funcionario.Unit();
                func.ReligarFuncionario(txt_Codigo.Text,DateTime.UtcNow.ToString("dd/MM/yyyy"));
                MessageBox.Show("Cadastro religado com sucesso.", "Programa Oficina", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
            }
            else
            {
